...
#from tensorflow.contrib import slim as slim_v1
import resnet_utils
    ...
    with tf.compat.v1.variable_scope(scope, 'resnet_v1', [inputs], reuse=reuse) as sc:
        ...
        with slim.arg_scope([slim.conv2d, bottleneck,
            ...
            with slim.arg_scope([slim.batch_norm], is_training=is_training):
                ...
                end_points['pool3'] = end_points.get('resnet_v1_50/block1', None)
                end_points['pool4'] = end_points.get('resnet_v1_50/block2', None)
                end_points['pool5'] = net
...
if __name__ == '__main__':
    ...
    with slim.arg_scope(resnet_utils.resnet_arg_scope()):
          logits, end_points = resnet_v1_50(input)
          print("ResNet-50 model built successfully.")
